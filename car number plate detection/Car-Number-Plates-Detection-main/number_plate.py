...
harcascade = r"C:\Users\saroj\Downloads\Car number plate\car number plate detection\Car-Number-Plates-Detection-main\model\haarcascade_russian_plate_number.xml"
